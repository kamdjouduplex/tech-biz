...
<html lang="en">
	<head>
		...
		<title>New employee geolocation</title>
                ...
                <div class="panel panel-info">
                  <div class="panel-heading">
                     <ul class="nav nav-tabs nav-justified">
					  ...
					  <li><a href="newEmployeeProfile">Employee Profile</a></li>
					  <li  class="active"><a href="newEmployeeGeoLocation">Employee Map location</a></li>
					</ul>
                  </div>
                  <div class="panel-body">
                   <form class="form-horizontal" role="form">
                   	<div class="raw">
	              		<img class="featurette-image img-responsive" data-src="holder.js/1075x500/auto" alt="Generic placeholder image">
	               </div>
	               <br>
                   	<p>
	                      <span class="pull-right">
