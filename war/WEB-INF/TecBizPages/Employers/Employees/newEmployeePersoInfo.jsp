...
<html lang="en">
	<head>
		...
		<title>New employee Infos</title>
        ...
        <span class="pull-left"><br><g:plusone></g:plusone></span>
				<span  class="pull-right">
						<div class="blog-masthead">
                                    ...
                                    <span class="glyphicon glyphicon-user"> </span> Create</a>|
                ...
                <div class="panel panel-info">
                  <div class="panel-heading">
                    <ul class="nav nav-tabs nav-justified">
					  <li class="active"><a href="newEmployeePersoInfo">Employee Personal Informations</a></li>
					</ul>
                  </div>
                  <div class="panel-body">
                   <form class="form-horizontal" action="" method="post" role="form">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                      <input type="text" class="form-control" id="inputEmail3" name="ename" placeholder="Employee Name" required>
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
	                    <div class="col-sm-10">
	                      <input class="form-control" type="password" name="epwd" id='dd' placeholder="Employee password" required>
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label for="inputPassword3" class="col-sm-2 control-label">Bird-day</label>
	                    <div class="col-sm-10">
	                      <input class="form-control" type="date" name="ebday" id='dd' required>
	                    </div>
	                  </div>
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                      <input type="text" class="form-control" id="inputEmail3" name="ebiz" placeholder="Employee Business" required>
	                    </div>
	                  </div>
	                  <input type="hidden" name="parent_employer" value="<%= userService.getCurrentUser().getEmail() %>" />
	               </div>
	               <div class="col-md-6">
	                    <div class="form-group">
	                  <label for="cat" class="col-sm-2 control-label">Country</label>
	                   ...
	                   <select name="ecountry" class="form-control" required>
	...
	<option value="Zimbabwe" title="Zimbabwe">Zimbabwe</option>
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                      <input type="text" class="form-control" name="eaddr"id="inputEmail3" placeholder="Employee address" required>
	                    </div>
	                  </div>
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                      <input class="form-control" type="tel" name="etel" placeholder="Employee phone" required>
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label for="inputEmail3" class="col-sm-2 control-label">Email</label>
	                    <div class="col-sm-10">
	                      <input type="email" class="form-control" id="inputEmail3" name="eemail" placeholder="Employee email" required>
	                    </div>
	                  </div>
             		</div>
             		</div>
             		<br>
                   	<p>
	                      <span class="pull-right">
	                      <button type="submit" class="btn btn-success">Create & send email &raquo;</button>
	                 	  </span>
