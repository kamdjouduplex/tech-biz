          ...
          <!-- the left vertical menu -->
              <div class="col-md-3 " id="bgcolor">
                  <ul class="nav nav-sidebar">
                  	<li class="active"><a href="employees"><span class="pull-right"><span class="glyphicon glyphicon-chevron-right"></span></span>Employees</a></li>
            ...
            <table class="table table-striped">
              ...
              %>
                <tr class="info">
                  ...
                  <td><a href="#"><%= myemp.getEmployeeName() %></a></td>
                  <td><%= myemp.getEmployeeCity() %></td>
                  <td><%= myemp.getEmployeeBusiness() %></td>
                  <td><%= myemp.getEmployeeEmail() %></td>
                  <td><a href="#">
