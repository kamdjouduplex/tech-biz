        ...
        <div class="row">
          ...
          <!-- the left vertical menu -->
              <div class="col-md-3 " id="bgcolor">
                  <ul class="nav nav-sidebar">
                  	<li  class="active"><a href="businesses"><span class="pull-right"><span class="glyphicon glyphicon-chevron-right"></span></span>Businesses</a></li>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody><% List<Business> biz = (List<Business>)request.getAttribute("mybusinesses");
              	for(Business mybiz: biz){
              %>
                <tr class="info">
                  <td><input type="checkbox"></td>
                  <td><a href="#"><%= mybiz.getBizName() %></a></td>
                  <td><%= mybiz.getBizCity() %></td>
                  <td><%= mybiz.getBizCategory() %></td>
                  <td><%= mybiz.getBizDate() %></td>
                  <td><a href="#">
