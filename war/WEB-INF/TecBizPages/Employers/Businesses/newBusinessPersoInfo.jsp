...
<html lang="en">
        ...
        <span class="pull-left"><br><g:plusone></g:plusone></span>
				<span  class="pull-right">
						<div class="blog-masthead">
									...
									<a class="blog-nav-item active" href="newBusinesssPersoInfo">  
                  					<span class="glyphicon glyphicon-briefcase"> </span> Create</a>|
                ...
                <div class="panel panel-info">
                  <div class="panel-heading">
                    <ul class="nav nav-tabs nav-justified">
					  <li class="active"><a href="newBusinessPersoInfo">Business Informations</a></li>
                  ...
                  <div class="panel-body">
                   <form class="form-horizontal" action="" method ="post" role="form">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                      <input type="text" class="form-control" name="bname" id="inputEmail3" placeholder="Business Name" required>
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label for="inputPassword3" class="col-sm-2 control-label">Created</label>
	                    <div class="col-sm-10">
	                      <input class="form-control" type="date" name="dtcreated" id='dd' required>
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label for="inputEmail3" class="col-sm-2 control-label">Address</label>
	                    <div class="col-sm-10">
	                      <input type="text" class="form-control" id="inputEmail3" name="addr" placeholder="Business address" required>
	                    </div>
	                  </div>
	                  <div class="form-group">
	               ...
	               <div class="col-md-6">
	                  <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                      <textarea class="form-control" rows="4" name="desc" placeholder="Brief description of the business." required></textarea>
	                    </div>
	                  </div>
	                  <div class="form-group">
	...
	<option value="Zimbabwe" title="Zimbabwe">Zimbabwe</option>
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                      <input type="text" class="form-control" name="cty" id="inputEmail3" placeholder="Business City" required>
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label for="inputPassword3" class="col-sm-2 control-label">Phone</label>
	                    <div class="col-sm-10">
	                      <input class="form-control" type="tel" name="contact" placeholder="Business phone number" required>
	                    </div>
	                  </div>
 					<input type="hidden" name="business_owner" value="<%= userService.getCurrentUser().getEmail() %>" />
             		</div>
             		</div>
             		<br>
                   	<p>
	                      <span class="pull-right">
	                      <button type="submit" class="btn btn-success"> Create Business &raquo;</button>
	                 	  </span>
