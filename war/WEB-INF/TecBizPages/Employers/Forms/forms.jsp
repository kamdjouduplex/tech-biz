        ...
        <div class="row">
          ...
          <!-- the left vertical menu -->
              <div class="col-md-3 " id="bgcolor">
                  ...
                  <li class="active"><a href="forms"><span class="pull-right"><span class="glyphicon glyphicon-chevron-right"></span></span>Forms</a></li>
