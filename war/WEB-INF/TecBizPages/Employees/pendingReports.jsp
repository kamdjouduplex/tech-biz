          ...
          <!-- the left vertical menu -->
              <div class="col-md-3 ">
                  <ul class="nav nav-sidebar">
                    <li class="active"><a href="pendingReports"><span class="pull-right"><span class="glyphicon glyphicon-chevron-right"></span></span>Pending Reports</a></li>
                    <li><a href="currentReports">Current Reprots</a></li>
